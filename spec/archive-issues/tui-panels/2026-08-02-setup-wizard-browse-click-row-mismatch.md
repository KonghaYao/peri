> 归档于 2026-08-11，原路径 spec/issues/2026-08-02-setup-wizard-browse-click-row-mismatch.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：Browse 步骤行高对齐（wizard_click 与 render_browse 一致），修复记录见正文 |
