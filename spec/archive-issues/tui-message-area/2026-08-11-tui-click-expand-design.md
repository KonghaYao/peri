> 归档于 2026-08-11，原路径 spec/issues/2026-08-11-tui-click-expand-design.md

# 消息区鼠标事件高层设计：单击/拖拽手势状态机 + 焦点单一事实源

**状态**：Closed
**关联 issue**：`2026-08-11-tui-click-expand-broken.md`（同目录归档，本设计已被其实施吸收）
**参考实现**：grok-build `xai-grok-pager` 消息区域（scrollback）鼠标事件设计
**创建日期**：2026-08-11

## 最新情况（2026-08-11）

设计已由 2026-08-11-tui-click-expand-broken 实施吸收（手势状态机 + FOCUSED_ENTRY 单一事实源）
