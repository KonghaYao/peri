> 归档于 2026-08-11，原路径 spec/issues/2026-07-22-p2-3-agent-tui-log-rotation.md
...
对应实现落地 tracing-appender Rotation::DAILY 轮转；现实现位于 peri-agent/src/telemetry/subscriber.rs
