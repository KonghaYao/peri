> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-auto-compact-triggers-spurious-session-reload.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：compact 判定前置化（flush 前评估 compact_just_completed），修复记录与测试见正文 |
