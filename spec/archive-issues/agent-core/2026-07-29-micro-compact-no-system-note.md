> 归档于 2026-08-11，原路径 spec/issues/2026-07-29-micro-compact-no-system-note.md

# Micro Compact 执行后 TUI 不显示 SystemNote

> **状态**：Fixed | **优先级**：中 | **类型**：Bug | **日期**：2026-07-29
...
| 2026-08-11 | Open | Fixed | agent | 归档：Micro Compact SystemNote 显示修复（Debug 格式 vs 文案错配），修复记录见正文 |
