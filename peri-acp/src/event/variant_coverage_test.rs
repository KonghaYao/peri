...
fn test_all_executor_event_variants_mapped() {
    ...
    let variants = [
        ...
        "ToolStart", "ToolEnd",
        "TextChunk", "AiReasoning",
        "SubagentStarted", "SubagentStopped",
        "ContextWarning", "StateSnapshot", "StateSnapshotMeta",
        "TurnCommitted", "TurnSuspended",
        "RewindCompleted", "BackgroundTaskCompleted",
        "BgToolStep", "LspDiagnostics",
        "AgentExecutionFailed",
        "WorkflowProgress",
        "TodoUpdate", "MessageAdded",
        "CompactError",
    ];
