> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-background-task-completed-event-dead-path.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：EventSink 映射补齐/死路径移除，修复记录见正文 |
