> 归档于 2026-08-11，原路径 spec/issues/2026-08-02-analyze-ts-days-value-overwrites-trace-limit.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：cli 数值参数解析修复（--days 不再覆盖位置参数），修复记录见正文 |
