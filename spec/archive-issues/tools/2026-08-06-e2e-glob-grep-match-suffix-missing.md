> 归档于 2026-08-11，原路径 spec/issues/2026-08-06-e2e-glob-grep-match-suffix-missing.md
...
| 2026-08-08 | Open | Fixed | agent | 修复记录完整（测试鲁棒性：滚动到消息区顶部再截图 + 头行后缀单测），e2e header-suffix-and-error 通过 114.6s；状态未随修复同步更新，本次盘点闭环 |
