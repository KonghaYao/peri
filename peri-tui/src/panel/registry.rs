...
pub fn create_panel(kind: PanelKind) -> Box<dyn super::PanelState> {
    match kind {
        PanelKind::Model => Box::new(PanelStateStub::new(kind)),
        PanelKind::Login => Box::new(PanelStateStub::new(kind)),
        PanelKind::Agent => Box::new(PanelStateStub::new(kind)),
        PanelKind::Hooks => Box::new(PanelStateStub::new(kind)),
        PanelKind::Config => Box::new(PanelStateStub::new(kind)),
        ...
        PanelKind::Status => Box::new(PanelStateStub::new(kind)),
        PanelKind::Memory => Box::new(PanelStateStub::new(kind)),
        PanelKind::Tasks => Box::new(PanelStateStub::new(kind)),
        PanelKind::Betas => Box::new(PanelStateStub::new(kind)),
