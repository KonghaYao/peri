...
│                 /::commands · Enter::send · Ctrl+K::mode            │
└──────────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                              │
│                 Enter::send · Ctrl+Enter::newline · @::mention-files     │
└──────────────────────────────────────────────────────────────────────────────┘
```
...
- 多行 buffer，Ctrl+Enter 换行。
- Enter 提交并写入输入历史。
- ↑/↓ 浏览历史；Esc 退出历史态或关闭局部浮层。
...
┌──────────────────────────────────────────────────────────────────────────────┐
│ Auto · perihelion · anthropic/claude-code-sonnet · CPU 12% · MEM 430MB        │
│                 /::commands · Ctrl+Enter::newline · Ctrl+K::mode · Ctrl+O::diff│
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```
