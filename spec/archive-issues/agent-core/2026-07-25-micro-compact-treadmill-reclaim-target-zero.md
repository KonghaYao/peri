> 归档于 2026-08-11，原路径 spec/issues/2026-07-25-micro-compact-treadmill-reclaim-target-zero.md

# Micro Compact 反复触发但压不住预算（跑步机效应 + reclaim_target=0）

> **状态**：Fixed | **优先级**：高 | **类型**：Bug | **日期**：2026-07-25
...
| 2026-08-11 | Open | Fixed | agent | 归档：reclaim_target 区间与跑步机效应修复，修复记录与测试见正文 |
