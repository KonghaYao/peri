> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-cancel-misreported-as-llm-failure.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：reason.rs match 分支修正（Interrupted 不再误报 LlmFailure），修复记录见正文 |
