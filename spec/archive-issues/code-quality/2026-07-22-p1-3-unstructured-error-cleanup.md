> 归档于 2026-08-11，原路径 spec/issues/2026-07-22-p1-3-unstructured-error-cleanup.md
...
对应实现：CompactNoLlm/CompactEmptyResponse + BackgroundRegistryError 结构化错误替代 anyhow/String
