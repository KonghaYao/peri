> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-loading-stuck-after-transport-close.md
...
| 2026-08-11 | Open | Fixed | agent | 归档：pump 独占 sender 方案 A + 真 wiring 验收测试（test_real_wiring_transport_death_resets_loading），修复记录见正文 |
