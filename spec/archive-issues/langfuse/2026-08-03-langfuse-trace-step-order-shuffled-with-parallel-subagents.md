> 归档于 2026-08-11，原路径 spec/issues/2026-08-03-langfuse-trace-step-order-shuffled-with-parallel-subagents.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：并行 subagent step 顺序修复，修复记录见正文 |
