> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-after-agent-failure-missing-turn-completed.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：Err 路径补发 TurnCompleted（含工具路径镜像问题一并处理），修复记录见正文 |
