> 归档于 2026-08-11，原路径 spec/issues/2026-08-06-e2e-rewind-input-not-refilled.md
...
| 2026-08-08 | Open | Fixed | agent | 修复记录完整（strip_system_reminders 剥离注入块），e2e rewind-v2 通过 57.7s；状态未随修复同步更新，本次盘点闭环 |
