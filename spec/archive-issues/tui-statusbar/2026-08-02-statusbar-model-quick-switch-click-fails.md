> 归档于 2026-08-11，原路径 spec/issues/2026-08-02-statusbar-model-quick-switch-click-fails.md
...
| 2026-08-11 | Resolved | Fixed | agent | 归档：model_click_areas 词级折行模拟重写（对齐 reflow.rs），28 status_bar 测试 + 694 lib 通过 |
