> 归档于 2026-08-11，原路径 spec/issues/2026-08-05-caps-negotiated-once-broken-second-session.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：caps 消费/注册修复：session/load/resume/fork 路径补 caps 注册 + TOCTOU 消除（commits 1ff4a0ff/6e924c8b），修复记录见正文 |
