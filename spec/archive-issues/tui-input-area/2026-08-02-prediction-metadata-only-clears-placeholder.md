> 归档于 2026-08-11，原路径 spec/issues/2026-08-02-prediction-metadata-only-clears-placeholder.md
...
| 2026-08-11 | Fixed | Fixed | agent | 终态确认归档：prediction 仅元数据时不再覆盖占位文本，修复记录见正文 |
