> 归档于 2026-08-11，原路径 spec/issues/2026-08-01-model-profiles-independent-config.md
...
ProfileConfig/Profiles 已落地（peri-acp/src/provider/config.rs），fable 档位与 ALIAS_OPTS 生效
